...
export const AKTION_LABEL: Record<string, string> = {
  ...
  'erinnerung.lauf': 'Erinnerungen verschickt',
  'module.geaendert': 'Module geändert',
  'aushang.angelegt': 'Aushang veröffentlicht',
  'aushang.geloescht': 'Aushang gelöscht',
  'passwort.reset': 'Passwort zurückgesetzt',
  'rolle.geaendert': 'Rollen geändert',
  'antrag.aufgenommen': 'Antrag aufgenommen',
  'antrag.abgelehnt': 'Antrag abgelehnt',
  'charge.angelegt': 'Charge angelegt',
  'charge.bearbeitet': 'Charge bearbeitet',
  'charge.geloescht': 'Charge gelöscht',
  'charge.freigegeben': 'Charge freigegeben',
  'charge.gesperrt': 'Charge gesperrt',
  'charge.rueckruf': 'Charge zurückgerufen',
  'vernichtung.erfasst': 'Vernichtung erfasst',
  'transport.erfasst': 'Transport dokumentiert',
  'verarbeitung.gebucht': 'Verarbeitung gebucht',
  'sorte.angelegt': 'Sorte angelegt',
